...
public class ModifyBotGUI {
	...
	public void populateActionTable(){
		...
		for(int i = 0; i<botActions.size(); i++){
			String[] rowData = { botActions.get(i).getAction(), botActions.get(i).getConditionType(), String.valueOf(botActions.get(i).getDelay()), botActions.get(i).getFormattedKeywords(), botActions.get(i).getTweetText() };
